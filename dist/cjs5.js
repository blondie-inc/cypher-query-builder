...
function uniqueString(str, existing) {
  ...
  if (!number || takenSuffixes.indexOf(number) !== -1) {
    number = Math.max.apply(Math, tslib.__spreadArrays([0], takenSuffixes)) + 1;
...
/** @class */
function (_super) {
  tslib.__extends(Pattern, _super);
...
/** @class */
function (_super) {
  tslib.__extends(NodePattern, _super);
...
/** @class */
function (_super) {
  tslib.__extends(RelationPattern, _super);
...
/** @class */
function (_super) {
  tslib.__extends(PatternClause, _super);
...
/** @class */
function (_super) {
  tslib.__extends(TermListClause, _super);
  /**
   * Accepts:
   *   node -> string
   *   many nodes -> string[]
...
function (_super) {
  ...
  Remove.prototype.build = function () {
    ...
    return "REMOVE " + tslib.__spreadArrays(labels, properties).join(', ');
  };
...
/** @class */
function (_super) {
  tslib.__extends(OrderBy, _super);
...
/** @class */
function (_super) {
  tslib.__extends(OnMatch, _super);
...
/** @class */
function (_super) {
  tslib.__extends(OnCreate, _super);
...
/** @class */
function (_super) {
  tslib.__extends(WhereAnd, _super);
...
/** @class */
function (_super) {
  tslib.__extends(WhereOr, _super);
...
/** @class */
function (_super) {
  tslib.__extends(WhereXor, _super);
...
/** @class */
function (_super) {
  tslib.__extends(WhereNot, _super);
...
/** @class */
function (_super) {
  tslib.__extends(Builder, _super);
  ...
  Builder.prototype.raw = function (clause) {
    ...
    return this.continueChainClause(new (Raw.bind.apply(Raw, tslib.__spreadArrays([void 0, clause], args)))());
  };
  /**
...
/** @class */
function (_super) {
  tslib.__extends(ClauseCollection, _super);
...
/** @class */
function (_super) {
  tslib.__extends(Connection, _super);
  /**
