 ...
 * @internal
 */
export declare class SetBlock<Q> {
    protected chain: (clause: Clause) => Q;
    protected wrapper?: WrapperClause | undefined;
    constructor(chain: (clause: Clause) => Q, wrapper?: WrapperClause | undefined);
    /**
     ...
     * ```
     */
    setValues(values: Dictionary<any>, merge?: boolean): Q;
    /**
     ...
     * ```
     */
    setVariables(variables: Dictionary<string | Dictionary<string>>, merge?: boolean): Q;
    private wrap;
}
/**
 ...
 * @internal
 */
export declare abstract class Builder<Q> extends SetBlock<Q> {
     ...
     * @returns {Q}
     */
    orderBy(fields: string | (string | OrderConstraint)[] | OrderConstraints, dir?: Direction): Q;
    /**
